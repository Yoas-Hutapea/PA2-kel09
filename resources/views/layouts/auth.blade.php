                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="dropdown-item  d-flex svg-icon border-top">
                                    <form method="POST" action="https://templates.iqonic.design/datum/laravel/public/logout">
                                        <input type="hidden" name="_token" value="5byoTtf2zpefU31rDuoemt3VnackypMvlNHwduMg">                                        <svg class="svg-icon mr-0 text-secondary" id="h-05-p" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                <li class=" sidebar-layout">
                    <a href="dashboard1.html" class="svg-icon">
                        <i class="">
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">                        
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/buttongroup.html" class="svg-icon">
                                <i class="">
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/boxshadows.html" class="svg-icon">
                                <i class="">
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/listgroup.html" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/media.html" class="svg-icon">
                                <i class="">
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/notification.html" class="svg-icon">
                                <i class="">
                        ...
                        <li class=" sidebar-layout">
                            <a href="ui/video.html" class="svg-icon">
                                <i class="">
                    ...
                    <ul id="app3" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="sidebar-layout">
                            ...
                            <ul id="form1" class="submenu collapse" data-parent="#app3">
                                <li class=" sidebar-layout">
                                    <a href="forms/control/layout.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/control/inputgroup.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">   
                                    <a href="forms/control/validation.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/control/switch.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/control/checkbox.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/control/radio.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/control/textarea.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="sidebar-layout">
                            ...
                            <ul id="form2" class="submenu collapse" data-parent="#app3">
                                <li class=" sidebar-layout">
                                    <a href="forms/widget/datepicker.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/widget/select.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/widget/fileuploader.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class=" sidebar-layout">
                                    <a href="forms/widget/quill.html" class="svg-icon">
                                        <i class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            </svg>
                ...
                <li class=""  class="sidebar-layout">
                    <a href="icons/heroicons.html" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="card-body-list">
                        <ul class="list-style-3 mb-0">
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('assets/auth/images/products/1.jpg')}}">
                                </div>
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('assets/auth/images/products/2.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('assets/auth/images/products/13.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <li class="p-3 list-item d-flex justify-content-start align-items-center">
                                <div class="avatar">
                                    <img class="avatar avatar-img avatar-60 rounded" src="{{asset('assets/auth/images/products/14.jpg')}}">
                                </div>
                                <div class="list-style-detail ml-3 mr-2">
                            ...
                            <table class="table mb-0">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{('assets/auth/images/user/2.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('assets/auth/images/user/5.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('assets/auth/images/user/1.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                            <div>Max Lynn</div>
                                        </div>
                                ...
                                <tr class="white-space-no-wrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-45 mr-2">
                                                <img src="{{asset('assets/auth/images/user/3.jpg')}}" class="img-fluid rounded-circle"
                                                     alt="image">
                                            </div>
                                            <div>Danniw Yatt</div>
                                        </div>
